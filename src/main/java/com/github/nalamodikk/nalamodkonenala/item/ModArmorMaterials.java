...
public enum ModArmorMaterials implements ArmorMaterial {
    nala_stone("nala_stone", 26, new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_GOLD, 1f, 0f, () -> Ingredient.of(ModItems.nala_stone.get()));
    ;
    ...
    public String getName() {
        return Konenalamod.MOD_ID + ":" + this.name;
    }
